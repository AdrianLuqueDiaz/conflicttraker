...
public class FactionController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<?> actualizar(@PathVariable Long id, @RequestBody FactionCreateDTO dto) {
        // Funcionalidad no implementada en esta entrega
        return ResponseEntity.status(HttpStatus.NOT_IMPLEMENTED).body("Funcionalidad en desarrollo");
    }
